...
<PropertiesTable
  content={[
    ...
    },
    {
      name: "opts",
      type: "object",
      description: "Optional configuration for the loop. The concurrency option controls how many iterations can run in parallel (default: 1)",
      isOptional: true,
      properties: [
        {
          name: "concurrency",
...
- [For each](../../docs/workflows/flow-control.mdx#foreach)