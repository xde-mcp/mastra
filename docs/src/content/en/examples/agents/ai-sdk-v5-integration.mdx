...
```ts showLineNumbers copy title="src/mastra/agents/index.ts"
...
```ts showLineNumbers copy title="src/mastra/tools/index.ts"
...
```ts showLineNumbers copy title="app/api/chat/route.ts"
...
```ts showLineNumbers copy title="app/api/initial-chat/route.ts"
import { mastra } from "@/src/mastra";
...
```tsx showLineNumbers copy title="app/page.tsx"
"use client";
