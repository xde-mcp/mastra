...
- [Parallel Steps workflow example](../../examples/workflows_vNext/parallel-steps.mdx)
- [Conditional Branching workflow example](../../examples/workflows_vNext/conditional-branching.mdx)
- [Inngest workflow example](../../examples/workflows_vNext/inngest-workflow.mdx)
- [Suspend and Resume workflow example](../../examples/workflows_vNext/human-in-the-loop.mdx)