...
Mastra Cloud is a deployment service built by the Mastra team that runs, manages, and monitors Mastra applications. It works with standard Mastra projects and handles deployment, scaling, and operational tasks. It is currently in beta. 
