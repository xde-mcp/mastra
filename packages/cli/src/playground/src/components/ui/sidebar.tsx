...
>(({ side = 'left', variant = 'sidebar', collapsible = 'offcanvas', className, children, ...props }, ref) => {
  ...
  if (collapsible === 'none') {
    return (
      <div
        className={cn('bg-sidebar-black text-sidebar-foreground flex h-full w-[--sidebar-width] flex-col', className)}
        ref={ref}
        {...props}
      >
        {children}
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile="true"
          className="bg-sidebar-black text-sidebar-foreground w-[--sidebar-width] p-0 [&>button]:hidden"
          style={
            {
  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="bg-sidebar-black group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow "
        >
          {children}
        </div>
      </div>
...
const SidebarSeparator = React.forwardRef<React.ElementRef<typeof Separator>, React.ComponentProps<typeof Separator>>(
  ({ className, ...props }, ref) => {
    return (
      <Separator ref={ref} data-sidebar="separator" className={cn('bg-surface2 mx-2 w-auto', className)} {...props} />
    );
  },
);
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          'group-data-[collapsible=icon] group-data-[collapsible=icon]:pl-0',
          className,
        )}
        {...props}
      />
