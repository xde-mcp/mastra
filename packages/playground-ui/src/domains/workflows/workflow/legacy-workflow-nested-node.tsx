...
import { LegacyWorkflowNestedGraphContext } from '../context/legacy-workflow-nested-graph-context';
...
export function LegacyWorkflowNestedNode({ data }: NodeProps<LegacyWorkflowNestedNode>) {
